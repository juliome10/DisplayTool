...
Feature: 28. Agregar diapositivas a unha lista de reprodución
Como usuario da aplicación
Quero poder engadir diapositivas a unha lista de reprodución
Para poder ampliar os contidos a amosar
...
Scenario: Agregar diapositivas a unha lista de reprodución
    ...
    And "Lista de reprodución" called "Lista Un" has 2 diapositivas